...
class BrowseDirectorySemanticsSourceTest {
    ...
    fun sourceFileNameBrowseKeepsPosterGridAndSourceNamesAcrossFolders() {
        ...
        assertTrue(browseSignature.contains("onExitToHome: () -> Unit = {}"))
        assertTrue(appBrowseCall.contains("sourceFileNameMode = browseSourceFileName"))
        assertTrue(appBrowseCall.contains("onExitToHome = ::exitSourceFileNameBrowseToHome"))
        assertTrue(handleNavigateBlock.contains("browseSourceFileName = params.getQueryParameter(\"sourceFileName\") == \"true\""))
        assertTrue(appSource.contains("fun exitSourceFileNameBrowseToHome()"))
        assertTrue(appSource.contains("navigateTopDestination(\"home\")"))
        assertTrue(backHandlerBlock.contains("if (browseSourceFileName)"))
        assertTrue(backHandlerBlock.contains("exitSourceFileNameBrowseToHome()"))
        ...
        assertTrue(screenBlock.contains("if (sourceFileNameMode)"))
        assertTrue(screenBlock.contains("onExitToHome()"))
        assertFalse(screenBlock.contains("sourceFileNameRouteSuffix(sourceFileNameMode)"))
